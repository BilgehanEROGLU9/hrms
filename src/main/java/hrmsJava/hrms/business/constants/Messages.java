package hrmsJava.hrms.business.constants;
...
public class Messages {
	...
	public static String invalidFirstName = "Hatalı ad bilgisi.";
	public static String invalidLastName = "Hatalı soyadı bilgisi.";
	public static String invalidBirthdate = "Hatalı Doğum tarihi bilgisi.";
	public static String invalidNationalIdentity = "Hatalı Kimlik Numarası bilgisi.";
	
	
	public static String invalidCompanyName = "Hatalı Şirket adı bilgisi.";
	public static String invalidCompanyNumber = "Hatalı Şirket iletişim numarası bilgisi.";
	public static String invalidCompanyWebsite = "Hatalı Şirket websitesi bilgisi.";
